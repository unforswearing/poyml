...
# todo: using a poyml file to concatenate multiple input files
...
#          title, date, body, comments, submitted  as arguments.
#          eg. `poyml --extract title,body poem.yaml`
#          the code will need to change to accommodate this new setup
